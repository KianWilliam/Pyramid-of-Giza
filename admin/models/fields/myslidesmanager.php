...
JText::script('COM_GIZA_SELECT_IMAGE_LABEL');
JText::script('COM_GIZA_SELECT_IMAGE_DESC');
JText::script('COM_GIZA_SELECT_IMAGE_TEXT_LABEL');
JText::script('COM_GIZA_SELECT_IMAGE_TEXT_DESC');
JText::script('COM_GIZA_SELECT_SLIDESHOW_REMOVE_LABEL');
...
class JFormFieldMyslidesmanager extends JFormField {
	...
	protected function getInput() {
		...
		$path = 'administrator/components/com_giza/models/fields/myslides/';
		...
		$html = '<input name="' . $this->name . '" id="myslides" type="hidden" value="' . $this->value . '" />'
				. '<input name="myaddslide" id="myaddslide"  type="button" value="' . JText::_('COM_GIZA_ADDSLIDE') . '"  onclick="javascript:addslidemy();" />'
